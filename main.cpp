...
int main() {
    ...
    */
        ...
        std::cout << "Got first GAddr: " << test.id << ", " << test.size << ", "
                  << reinterpret_cast<void *>(test.ptr)
                  << std::endl;
        ...
        std::cout << "Got second GAddr: " << test2.id << ", " << test2.size << ", "
                  << reinterpret_cast<void *>(test2.ptr)
                  << std::endl;
        ...
        std::cout << "Done. Result: ";
        std::cout << result << ", and now reading from cache"
                  << std::endl;
...
//        auto filesga = reinterpret_cast<defs::SendGlobalAddr *>(filea);
        ...
        auto structdata = defs::Data(sizeof(Test), reinterpret_cast<char *>(&teststruct), test3);

        test3 = node.write(structdata);
